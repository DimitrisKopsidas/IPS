...
LEFT JOIN 
	MINIGAME MI ON MI.MINIGAME = I.MINIGAME
LEFT JOIN
	PROMOLINES PRO ON PRO.PROMO = I.PROMO AND I.MINIGAME = PRO.MINIGAME
LEFT JOIN
	CAROUSEL C ON C.CAROUSEL = I.CAROUSEL
LEFT JOIN 
	DEVICE D ON D.DEVICE = I.DEVICE
